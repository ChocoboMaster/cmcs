<?php
	...
	function showInstalledPlugins(){
		...
		foreach($plugins as $name){
			...
			echo "<tr>
					<td>$name</td>
						<td>
							<button type='button' class='btn btn-danger' "; echo ($bukkit) ? "":""; echo "><i class='glyphicon glyphicon-white glyphicon-trash'></i> Supprimer</button>
						</td>
					</tr>";			
		}
	...
	function showSuggested(){
		...
		echo "<div class='widget col-md-6 m0'>
			<table class='table table-striped'>
				<thead>
					<tr>
						<th>Suggestion</th>
				...
				<tbody>
					<tr>
						...
						<td>
							<button type='button' class='btn btn-primary' "; if(in_array("Essentials", $plugins)){echo "disabled";} echo "><i class='glyphicon glyphicon-white glyphicon-download-alt'></i> Installer</button>							
						</td>
					</tr>
					<tr>
						...
						<td>
							<button type='button' class='btn btn-primary' "; if(in_array("iConomy", $plugins)){echo "disabled";} echo "><i class='glyphicon glyphicon-white glyphicon-download-alt'></i> Installer</button>
						</td>
					</tr>
					<tr>
						...
						<td>
							<button type='button' class='btn btn-primary' "; if(in_array("Factions", $plugins)){echo "disabled";} echo "><i class='glyphicon glyphicon-white glyphicon-download-alt'></i> Installer</button>
						</td>
					</tr>
					<tr>
						...
						<td>
							<button type='button' class='btn btn-primary' "; if(in_array("Lockette", $plugins)){echo "disabled";} echo "><i class='glyphicon glyphicon-white glyphicon-download-alt'></i> Installer</button>
						</td>
					</tr>
					<tr>
						...
						<td>
							<button type='button' class='btn btn-primary' "; if(in_array("GroupManager", $plugins)){echo "disabled";} echo "><i class='glyphicon glyphicon-white glyphicon-download-alt'></i> Installer</button>
						</td>
					</tr>
					<tr>
						...
						<td>
							<button type='button' class='btn btn-primary' "; if(in_array("MineJobs", $plugins)){echo "disabled";} echo "><i class='glyphicon glyphicon-white glyphicon-download-alt'></i> Installer</button>
						</td>
					</tr>
					<tr>
						...
						<td>
							<button type='button' class='btn btn-primary' "; if(in_array("NoCheatPlus", $plugins)){echo "disabled";} echo "><i class='glyphicon glyphicon-white glyphicon-download-alt'></i> Installer</button>
						</td>
					</tr>
					<tr>
						...
						<td>
							<button type='button' class='btn btn-primary' "; if(in_array("Orebfuscator", $plugins)){echo "disabled";} echo "><i class='glyphicon glyphicon-white glyphicon-download-alt'></i> Installer</button>
						</td>
					</tr>
					<tr>
						...
						<td>
							<button type='button' class='btn btn-primary' "; if(in_array("Multiverse", $plugins)){echo "disabled";} echo "><i class='glyphicon glyphicon-white glyphicon-download-alt'></i> Installer</button>
						</td>
					</tr>
					<tr>
						...
						<td>
							<button type='button' class='btn btn-primary' "; if(in_array("WorldEdit", $plugins)){echo "disabled";} echo "><i class='glyphicon glyphicon-white glyphicon-download-alt'></i> Installer</button>
						</td>
					</tr>
				</tbody>
			</table>
